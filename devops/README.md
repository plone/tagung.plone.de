...
You need either a Ubuntu or Debian based system for tagung.plone.de, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/tagung.plone.de.yml` to the remote server with:
